...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ProcessRecord;ILandroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZ)V
    ...
    invoke-direct {v6, p0}, Lcom/android/server/am/ActivityRecord$Token;-><init>(Lcom/android/server/am/ActivityRecord;)V
    ...
    iput-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->waitingVisible:Z
    ...
    iput-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->thumbnailNeeded:Z
    ...
    iput-object v6, p0, Lcom/android/server/am/ActivityRecord;->baseDir:Ljava/lang/String;
    ...
    iput-object v6, p0, Lcom/android/server/am/ActivityRecord;->resDir:Ljava/lang/String;
    ...
    iput-object v6, p0, Lcom/android/server/am/ActivityRecord;->dataDir:Ljava/lang/String;
    ...
    iget-object v6, v1, Landroid/content/pm/ApplicationInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;
    ...
    iput-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->topIntent:Z
    ...
    :goto_3
    iput-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->floatingWindow:Z

    .line 405
    iget-object v6, p0, Lcom/android/server/am/ActivityRecord;->stack:Lcom/android/server/am/ActivityStack;
    ...
    iget-object v7, p0, Lcom/android/server/am/ActivityRecord;->stack:Lcom/android/server/am/ActivityStack;
    ...
    .line 407
    .local v2, baseRecord:Lcom/android/server/am/ActivityRecord;
    :goto_4
    if-eqz v2, :cond_4
    ...
    :goto_6
    iput-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->newTask:Z

    .line 416
    if-eqz v4, :cond_4

    iget-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->newTask:Z
    ...
    .line 426
    .end local v4           #floats:Z
    .end local v5           #taskAffinity:Z
    :cond_4
    iget-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->floatingWindow:Z
    ...
    .line 433
    iget-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->topIntent:Z
    ...
    invoke-virtual {v6, v7, v8, v9, v10}, Lcom/android/server/AttributeCache;->get(ILjava/lang/String;I[I)Lcom/android/server/AttributeCache$Entry;
    ...
    :cond_9
    move-object/from16 v0, p5
    invoke-virtual {p0, v0}, Lcom/android/server/am/ActivityRecord;->initIsHomeActivity(Landroid/content/Intent;)Z

    move-result v6

    iput-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->isHomeActivity:Z
    ...
    .line 511
    .end local v2           #baseRecord:Lcom/android/server/am/ActivityRecord;
    ...
    .line 409
    .restart local v2       #baseRecord:Lcom/android/server/am/ActivityRecord;
    :cond_f
    const/4 v4, 0x0
    ...
    .line 412
    .restart local v4       #floats:Z
    .restart local v5       #taskAffinity:Z
    :cond_10
    const/4 v6, 0x0
