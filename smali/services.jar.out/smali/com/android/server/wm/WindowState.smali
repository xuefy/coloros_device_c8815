...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-interface {v6, v0}, Landroid/view/WindowManagerPolicy;->getWallpaperWidth(I)I

    move-result v6

    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/wm/WindowState;->mPolicy:Landroid/view/WindowManagerPolicy;

    move/from16 v0, v16

    invoke-interface {v7, v0}, Landroid/view/WindowManagerPolicy;->getWallpaperHeight(I)I
...
.method hideLw(ZZ)Z
    ...
    invoke-static {v3, v4, p1, p2}, Lcom/android/server/wm/OppoWindowStateHelper;->hideLwExtr(Landroid/view/WindowManager$LayoutParams;Lcom/android/server/wm/WindowList;ZZ)Z
...
.method showLw(ZZ)Z
    ...
    invoke-static {v0, v2, p1, p2}, Lcom/android/server/wm/OppoWindowStateHelper;->showLwExtr(Landroid/view/WindowManager$LayoutParams;Lcom/android/server/wm/WindowList;ZZ)Z
