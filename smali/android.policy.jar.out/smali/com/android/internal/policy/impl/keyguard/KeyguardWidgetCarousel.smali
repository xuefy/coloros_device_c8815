...
.method public showInitialPageHints()V
    ...
    .line 106
    iput-boolean v5, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetCarousel;->mShowingInitialHints:Z
    ...
    .line 110
    .local v4, inVisibleRange:Z
    :goto_1
    invoke-virtual {p0, v3}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetCarousel;->getWidgetPageAt(I)Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;

    move-result-object v1

    .line 111
    .local v1, child:Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;
    if-eqz v4, :cond_2

    .line 112
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetCarousel;->getContext()Landroid/content/Context;
    ...
    const-string v8, "lockscreen_hide_initial_page_hints"
    ...
    .line 114
    .local v0, HideHints:I
    if-eq v0, v5, :cond_0

    .line 115
    const v7, 0x3f19999a

    invoke-virtual {v1, v7}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->setBackgroundAlpha(F)V

    .line 117
    :cond_0
    const/high16 v7, 0x3f80

    invoke-virtual {v1, v7}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->setContentAlpha(F)V

    .line 108
    .end local v0           #HideHints:I
    :goto_2
    add-int/lit8 v3, v3, 0x1

    goto :goto_0

    .end local v1           #child:Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;
    .end local v4           #inVisibleRange:Z
    :cond_1
    move v4, v6
    ...
    .line 119
    .restart local v1       #child:Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;
    .restart local v4       #inVisibleRange:Z
    :cond_2
    invoke-virtual {v1, v9}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->setBackgroundAlpha(F)V

    .line 120
    invoke-virtual {v1, v9}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->setContentAlpha(F)V
