...
.method static synthetic access$1400(Landroid/content/SyncManager$SyncHandler;Landroid/accounts/Account;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$1700(Landroid/content/SyncManager$SyncHandler;)Ljava/lang/Long;
    .locals 1
    .parameter "x0"
...
.method private dispatchSyncOperation(Landroid/content/SyncOperation;)Z
    ...
    #getter for: Landroid/content/SyncManager;->mSyncStorageEngine:Landroid/content/SyncStorageEngine;
    invoke-static {v1}, Landroid/content/SyncManager;->access$800(Landroid/content/SyncManager;)Landroid/content/SyncStorageEngine;
...
.method private getSyncWakeLock(Landroid/accounts/Account;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v3}, Landroid/content/SyncManager;->access$2300(Landroid/content/SyncManager;)Landroid/os/PowerManager;
...
.method private installHandleTooManyDeletesNotification(Landroid/accounts/Account;Ljava/lang/String;JI)V
    ...
    invoke-static {v2}, Landroid/content/SyncManager;->access$1600(Landroid/content/SyncManager;)Landroid/content/Context;
    ...
    #getter for: Landroid/content/SyncManager;->mContext:Landroid/content/Context;
    invoke-static {v3}, Landroid/content/SyncManager;->access$1600(Landroid/content/SyncManager;)Landroid/content/Context;
    ...
    invoke-static {v2}, Landroid/content/SyncManager;->access$4300(Landroid/content/SyncManager;)Landroid/content/Context;
...
.method private isActivityAvailable(Landroid/content/Intent;)Z
    ...
    #getter for: Landroid/content/SyncManager;->mContext:Landroid/content/Context;
    invoke-static {v6}, Landroid/content/SyncManager;->access$1600(Landroid/content/SyncManager;)Landroid/content/Context;
...
.method private maybeStartNextSyncLocked()J
    ...
    #getter for: Landroid/content/SyncManager;->mDataConnectionIsConnected:Z
    invoke-static/range {v36 .. v36}, Landroid/content/SyncManager;->access$500(Landroid/content/SyncManager;)Z
    ...
    invoke-static/range {v36 .. v36}, Landroid/content/SyncManager;->access$2600(Landroid/content/SyncManager;)[Landroid/accounts/AccountAndUser;

    move-result-object v5

    .line 1959
    .local v5, accounts:[Landroid/accounts/AccountAndUser;
    invoke-static {}, Landroid/content/SyncManager;->access$2900()[Landroid/accounts/AccountAndUser;
    ...
    invoke-static/range {v36 .. v36}, Landroid/content/SyncManager;->access$400(Landroid/content/SyncManager;)Landroid/net/ConnectivityManager;
    ...
    invoke-static/range {v36 .. v36}, Landroid/content/SyncManager;->access$700(Landroid/content/SyncManager;)Landroid/content/SyncQueue;
    ...
    #getter for: Landroid/content/SyncManager;->mSyncQueue:Landroid/content/SyncQueue;
    invoke-static/range {v39 .. v39}, Landroid/content/SyncManager;->access$700(Landroid/content/SyncManager;)Landroid/content/SyncQueue;
    ...
    #getter for: Landroid/content/SyncManager;->mContext:Landroid/content/Context;
    invoke-static/range {v36 .. v36}, Landroid/content/SyncManager;->access$1600(Landroid/content/SyncManager;)Landroid/content/Context;
    ...
    invoke-static {v0, v5, v1, v2}, Landroid/content/SyncManager;->access$2800(Landroid/content/SyncManager;[Landroid/accounts/AccountAndUser;Landroid/accounts/Account;I)Z
    ...
    #getter for: Landroid/content/SyncManager;->mSyncStorageEngine:Landroid/content/SyncStorageEngine;
    invoke-static/range {v36 .. v36}, Landroid/content/SyncManager;->access$800(Landroid/content/SyncManager;)Landroid/content/SyncStorageEngine;
    ...
    invoke-static/range {v36 .. v36}, Landroid/content/SyncManager;->access$3000(Landroid/content/SyncManager;)Landroid/os/UserManager;
    ...
    invoke-static {v0, v1}, Landroid/content/SyncManager;->access$900(Landroid/content/SyncManager;I)V
    ...
    :cond_23
    invoke-static {}, Landroid/content/SyncManager;->access$3300()I
...
.method private runBoundToSyncAdapter(Landroid/content/SyncManager$ActiveSyncContext;Landroid/content/ISyncAdapter;)V
    ...
    invoke-static {v3, v2}, Landroid/content/SyncManager;->access$3400(Landroid/content/SyncManager;Landroid/content/SyncOperation;)V
...
.method private runSyncFinishedOrCanceledLocked(Landroid/content/SyncResult;Landroid/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-static {v2, v5}, Landroid/content/SyncManager;->access$3500(Landroid/content/SyncManager;Landroid/content/SyncOperation;)V
...
.method private scheduleReadyPeriodicSyncs()J
    ...
    #getter for: Landroid/content/SyncManager;->mRunningAccounts:[Landroid/accounts/AccountAndUser;
    invoke-static {v4}, Landroid/content/SyncManager;->access$2600(Landroid/content/SyncManager;)[Landroid/accounts/AccountAndUser;
    ...
    invoke-static {v6}, Landroid/content/SyncManager;->access$2700(Landroid/content/SyncManager;)I
    ...
    #getter for: Landroid/content/SyncManager;->mSyncRandomOffsetMillis:I
    invoke-static {v4}, Landroid/content/SyncManager;->access$2700(Landroid/content/SyncManager;)I
    ...
    #calls: Landroid/content/SyncManager;->containsAccountAndUser([Landroid/accounts/AccountAndUser;Landroid/accounts/Account;I)Z
    invoke-static {v4, v0, v5, v6}, Landroid/content/SyncManager;->access$2800(Landroid/content/SyncManager;[Landroid/accounts/AccountAndUser;Landroid/accounts/Account;I)Z
    ...
    #getter for: Landroid/content/SyncManager;->mSyncStorageEngine:Landroid/content/SyncStorageEngine;
    invoke-static {v14}, Landroid/content/SyncManager;->access$800(Landroid/content/SyncManager;)Landroid/content/SyncStorageEngine;
...
.method private sendSyncStateIntent()V
    ...
    #getter for: Landroid/content/SyncManager;->mContext:Landroid/content/Context;
    invoke-static {v1}, Landroid/content/SyncManager;->access$1600(Landroid/content/SyncManager;)Landroid/content/Context;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v11}, Landroid/content/SyncManager;->access$2400(Landroid/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v11, v12}, Landroid/content/SyncManager;->access$2500(Landroid/content/SyncManager;Landroid/content/SyncManager$ActiveSyncContext;)Z
    ...
    #getter for: Landroid/content/SyncManager;->mSyncManagerWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v12}, Landroid/content/SyncManager;->access$2400(Landroid/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
    ...
    #calls: Landroid/content/SyncManager;->isSyncStillActive(Landroid/content/SyncManager$ActiveSyncContext;)Z
    invoke-static {v11, v1}, Landroid/content/SyncManager;->access$2500(Landroid/content/SyncManager;Landroid/content/SyncManager$ActiveSyncContext;)Z
    ...
    invoke-static {v11}, Landroid/content/SyncManager;->access$1200(Landroid/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
    ...
    #getter for: Landroid/content/SyncManager;->mHandleAlarmWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v12}, Landroid/content/SyncManager;->access$1200(Landroid/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
...
.method public onBootCompleted()V
    ...
    invoke-static {v0, v1}, Landroid/content/SyncManager;->access$2102(Landroid/content/SyncManager;Z)Z

    .line 1653
    iget-object v0, p0, Landroid/content/SyncManager$SyncHandler;->this$0:Landroid/content/SyncManager;

    #calls: Landroid/content/SyncManager;->doDatabaseCleanup()V
    invoke-static {v0}, Landroid/content/SyncManager;->access$2200(Landroid/content/SyncManager;)V
